# Cookiecutter Conda Data Science guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `project_ds/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `project_ds` folder and use the modules inside your notebooks :
...
```python
from project_ds.utils.paths import data_dir
data_dir()
```
